...
# html_logo = '_static/images/logo-org@2x.png'
# html_logo = '_static/images/touch-icon-310x310.png'
...
htmlhelp_basename = 'AmesPAHdbPythonSuitedoc'
...
man_pages = [
    (master_doc, 'pahdbwebsitemanual', 'PAHdb website manual',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PAHdbwebsitemanual', 'PAHdb website manual',
     author, 'PAHdbwebsitemanual', 'One line description of project.',
     'Miscellaneous'),
]
